...
class CAMker:
    def __init__(self):
        self.headers = {
            "User-Agent": random.choice([
                ...
                "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:97.0) Gecko/20100101 Firefox/97.0",
                "Moz
                illa/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.71 Safari/537.36",
    ...
    def check_cameras(self, country_code):
        try:
           path = self.countriess.get(country_code)
...
\033[0;97m9.\033[0;94m Indonesia
